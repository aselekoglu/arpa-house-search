...
export const createSearchProfileHandlers = ({ lifecycle, contextMapper = createProfileExecutionContext } = {}) => {
  if (
    lifecycle == null ||
...
const lifecycle = createSearchProfileLifecycleService({ storage: searchProfileStorage });
const service = restana();
const searchProfileRouter = service.newRouter();
const handlers = createSearchProfileHandlers({ lifecycle });
