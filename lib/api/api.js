...
import { customSourceRouter } from './routes/customSourceRouter.js';
import { searchProfileRouter } from './routes/searchProfileRouter.js';
import { listingFeedRouter } from './routes/listingFeedRouter.js';
...
service.use('/api/sources', authInterceptor());
service.use('/api/searchProfiles', authInterceptor());
service.use('/api/listing-feed', authInterceptor());
...
service.use('/api/sources', customSourceRouter);
service.use('/api/searchProfiles', searchProfileRouter);
service.use('/api/listing-feed', listingFeedRouter);
